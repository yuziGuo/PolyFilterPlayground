...
from data.linkx.load_data import load_twitch, load_fb100, load_twitch_gamer, DATAPATH
from data.linkx.data_utils import rand_train_test_idx, even_quantile_labels, to_sparse_tensor, dataset_drive_url
...
def load_genius():
    filename = 'genius'
    dataset = NCDataset(filename)
    fulldata = scipy.io.loadmat(f'dataset/linkx/genius.mat')
